<template>
  <div class="flex flex-col justify-between items-start h-[400px] w-5/6 bg-transparent rounded-md overflow-y-auto overflow-x-hidden">
    <div v-for="(epi, index) in episEspecificos" :key="index" id="check-container" class="h-12 std-input-field bg-white border-white drop-shadow-xl relative w-full">
